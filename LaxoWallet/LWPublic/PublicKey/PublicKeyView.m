...
@interface PublicKeyView ()<WKScriptMessageHandler, WKUIDelegate, WKNavigationDelegate>

@property (nonatomic, strong) WKWebView *  webView;

@end

@implementation PublicKeyView
static PublicKeyView *instance = nil;
...
//    NSString *jsString = [NSString stringWithFormat:@"changeColor('%@')", @"Js颜色参数"];
    NSString *JSstring = @"getInitData()";
    [_webView evaluateJavaScript:JSstring completionHandler:^(id _Nullable data, NSError * _Nullable error) {
        NSLog(@"改变HTML的背景色");
    }];
}

- (void)getInitDataBlock:(void (^)(NSDictionary * _Nonnull))successBlock{
    NSString *JSstring = @"getInitData()";
...
- (void)webView:(WKWebView *)webView runJavaScriptAlertPanelWithMessage:(NSString *)message initiatedByFrame:(WKFrameInfo *)frame completionHandler:(void (^)(void))completionHandler {
    ...
    [LogicHandle presentViewController:alertController animate:nil];
