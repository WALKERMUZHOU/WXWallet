...
- (void)createUI{
    ...
    self.bitLabel.text = [NSString stringWithFormat:@"%@ BSV",self.model.transAmount];
        ...
        [self.nextBtn setTitle:[NSString stringWithFormat:@"Send %@ BSV",self.model.transAmount] forState:UIControlStateNormal];
    ...
    if (self.walletModel.type == 1) {
            ...
            self.feeLabel.text = [NSString stringWithFormat:@"Network fee of %@ BSV",[LWNumberTool formatSSSFloat: self.trans.fee.integerValue/1e8]];
    ...
    //                    [successVC setSuccessWithAmount:amount andaddress:address andnote:note andfee:[LWNumberTool formatSSSFloat:weakself.trans.fee.integerValue/1e8]];
            ...
            self.feeLabel.text = [NSString stringWithFormat:@"Network fee of %@ BSV",[LWNumberTool formatSSSFloat: self.mutipyTrans.fee.integerValue/1e8]];
...
- (IBAction)nextClick:(UIButton *)sender {
    ...
    if ([noteStr hasPrefix:@"Note:"]) {
        noteStr = [noteStr stringByReplacingCharactersInRange:NSMakeRange(0, 5) withString:@""];
    }
