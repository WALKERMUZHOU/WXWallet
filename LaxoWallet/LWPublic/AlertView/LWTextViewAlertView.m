...
#import "LWTextViewAlertView.h"
#import "Masonry.h"
@interface LWTextViewAlertView()<UITextViewDelegate>
...
@implementation LWTextViewAlertView
...
-(void)evaluate_makeSure_buttonAction{
    NSLog(@"评价了-----view");
    if (self.lwAlertViewMakeSureBlock) {
        self.lwAlertViewMakeSureBlock(@"打回内容详情");
        [self dismissAlertView];
    }
}
