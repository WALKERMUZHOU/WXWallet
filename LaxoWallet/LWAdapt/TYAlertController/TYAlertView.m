...
- (void)layoutButtons
{
    ...
    if (_buttons.count == 1) {
        ...
        [_buttonContentView addConstraintWithView:button topView:nil leftView:_buttonContentView bottomView:_buttonContentView rightView:_buttonContentView edgeInset:UIEdgeInsetsMake(0, 0, -30, 0)];
        [_buttonContentView addConstraintEqualWithView:button widthToView:nil heightToView:lastSecondBtn];
    }
    
    if(_isManualDesign1 && _buttons.count == 2){
         UIButton *firstBtn = _buttons[0];
        UIButton *lastSecondBtn = _buttons[1];
        
         [_buttonContentView removeConstraintWithView:firstBtn attribute:NSLayoutAttributeRight];
         [_buttonContentView removeConstraintWithView:firstBtn attribute:NSLayoutAttributeBottom];
        [_buttonContentView removeConstraintWithView:lastSecondBtn attribute:NSLayoutAttributeTop];
         [_buttonContentView addConstraintWithView:firstBtn topView:nil leftView:nil bottomView:nil rightView:_buttonContentView edgeInset:UIEdgeInsetsZero];
         [_buttonContentView addConstraintWithTopView:firstBtn toBottomView:lastSecondBtn constant:_buttonSpace];
        [firstBtn addConstraintWidth:0 height:50];
        [lastSecondBtn addConstraintWidth:0 height:50];

        [firstBtn setBackgroundColor:lwColorGray];
        [firstBtn setTitleColor:lwColorBlack1 forState:UIControlStateNormal];
        [lastSecondBtn setBackgroundColor:lwColorNormal];
        [lastSecondBtn setTitleColor:lwColorWhite forState:UIControlStateNormal];
        ...
        [_buttonContentView addConstraintEqualWithView:button widthToView:nil heightToView:lastSecondBtn];
        self.kheight = 180;
        self.kwidth = kScreenWidth;
        
        [WMZDialogTool setView:self Radii:CGSizeMake(10,10) RoundingCorners:UIRectCornerTopLeft |UIRectCornerTopRight];
